...
const reasonLabel: Record<string, string> = {
  ...
  OVERNIGHT_PRIORITY_LOW_WATCH: "跨日资金线索，等待当日低位确认",
  OVERNIGHT_PRIORITY_LOW_REENTRY_SHADOW_CONFIRMED: "跨日低位研究确认（尚未开放买入提醒）",
  OVERNIGHT_PRIORITY_PENDING_RECONFIRMATION: "等待当日价格与资金重新确认",
  OVERNIGHT_PRIORITY_CAPITAL_UNRESOLVED: "后续资金转弱，保留观察但暂不建仓",
  OVERNIGHT_PRIORITY_EXPIRED: "已超过三个交易日观察期限",
  OVERNIGHT_PRIORITY_UNAVAILABLE: "跨日线索或交易日历待复核",
...
const strategyLabel: Record<string, string> = {
  ...
  post_invalidation_flow_recovery: "失效后资金反转",
};
