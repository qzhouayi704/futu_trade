...
export default function V2WorkbenchPage() {
  ...
  useEffect(() => {
    ...
    const refresh = () => client.invalidateQueries({
      queryKey: ["v2"],
      predicate: (query) => query.queryKey[1] !== "alert-performance" || query.queryKey[3] === "alerts",
    });
