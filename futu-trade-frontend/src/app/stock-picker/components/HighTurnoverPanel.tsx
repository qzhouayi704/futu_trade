...
import { useTickerAutoRefresh } from "@/app/high-turnover/hooks/useTickerAutoRefresh";
import HighTurnoverFilters from "@/app/high-turnover/components/HighTurnoverFilters";
import HighTurnoverTable from "@/app/high-turnover/components/HighTurnoverTable";
import type { SortField, SortDirection } from "@/app/high-turnover/components/HighTurnoverTable";
...
/** 流动性等级筛选类型 */
type LiquidityFilter = "all" | "A" | "B" | "C";

export default function HighTurnoverPanel() {
  ...
  const [liquidityFilter, setLiquidityFilter] = useState<LiquidityFilter>("all"); // 新增流动性筛选
  ...
  const displayStocks = useMemo(() => {
    ...
    if (liquidityFilter !== "all") {
      filtered = filtered.filter((s) => s.liquidity_level === liquidityFilter);
    }
  ...
  }, [stocks, marketFilter, searchKeyword, directionFilter, liquidityFilter, sortField, sortDirection]);
